...
export const groupsSheet = {
  label: "Buka Peta Kelompok (Google Sheet)",
  url: "https://docs.google.com/spreadsheets/d/18l47Wy-9GrPJXPwQ1e_AzG-XV93Kj-lYfDcdrbVYqD0/edit?gid=0#gid=0",
  note: "Kode kelompok, nama & organisasi tiap mentor, dan jumlah mentee kini dikelola langsung di sheet ini, bukan lagi dicetak statis di halaman ini — susunannya masih dapat berubah mengikuti kesepakatan internal antar mentor.",
};
